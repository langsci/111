...
hierarchy \citet[140]author{paggio:09} proposes for \ili{Danish} is shown in
...
system as its a common structure in human languages. This is highly
...
of the theory \citep{steedman:00}.\footnote{CCG departing from CC
  ...
  with functional categories and their arguments, which specify
