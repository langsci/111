...
followings: (i) Every sentence has at least one \isi{focus}, because new
...
basic notion of \isi{focus} as \myref{def:focus}.
...
\item{Pragmatic Presupposition: the set of presuppositions
  ...
  at the time of speech. (Ibid.\ p.\ 52)}
...
(a.k.a.\ non-contrastive focus)\is{non-contrastive focus}
...
{`Mary picked for herself \textsc{a hat}.' [hun] (Ibid.\ p.\ 249)}}}
...
(a.k.a.\ non-contrastive focus),\is{non-contrastive focus} and (c-iii) contrastive
...
\myexe{\enumsentence{\toplabel{def:buring:10} Focus Prominence: Focus
     needs to be maximally prominent. \citep[p.\ 277]{buring:10}}}
...
focus)\isi{non-contrastive focus} and contrastive focus for two main
...
A2:  & {John married \textsc{Rosa}, but didn't really \textsc{love} her.} \\
 & \multicolumn{1}{r}{\citep[p.\ 136]{lambrecht:96}}\\
\end{tabular}}}
...
conveying \isi{focus} meaning.  It is well-known that subjects in
\isi{subject-drop} languages such as \ili{Italian} and \ili{Spanish}
...
\item\shortexnt{2}
  {{\O} & Bebo.}
  {(I) & drink.\textsc{1sg} [spa]}
\item\shortexnt{3}
  {{\O} & swul & masi-n-at.}
  {(I) & alcohol & drink-\textsc{Ypres-decl} [kor]}
\item\shortexnt{3}
  {(w\v{o}) & h\={e} & j\v{i}u.}
  {I & drink & alcohol [cmn]}}}
...
\item Chocolate he \textsc{loves}. \citep[p.\ 2]{engdahl:vallduvi:96}}}
...
\item{\textsc{Dogs} must be carried. \citep[p.\ 169]{partee:91}}}}
...
in the previous subsection (\myS{3:sssec:inomissibility}),
...
Q: & { \shortex{4}{Mayksu-nun/ka & ecey & mwues-ul
    ...
    what-\textsc{acc} & see-\textsc{pst}-\textsc{int}} {`What did Max
    see yesterday.'}}\\
...
three components, including \isi{background}.  In fact, their
...
\myexe{\enumsentence{\toplabel{def:jacobs} Frame-setting: In (X Y), X is
    ...
    restricted. \citep[p.\ 656]{jacobs:01}}}
...
\begin{tabular}[t]{ll}
Q: & {How is John?}\\
A: & {\{Healthwise\}, he is \textsc{fine} \citep[p.\ 128]{fery:krifka:08}.}\\
\end{tabular}}}
...
\begin{tabular}[t]{ll}
Q: & {How is John?}\\
A: & {\{As for his health\}, he is \textsc{fine} \citep[p.\ 128]{fery:krifka:08}.}\\
\end{tabular}}}
...
{`Physically, Peter is doing very well.' [ger] \citep[p.\ 169]{dipper:etal:07}}}}
...
clauses. For instance, in \myref{lp:eng:14:13}, taken from \textit{The
...
\item\shortex{4}
  ...
  {`Cheolsoo said that life is limited.' [kor] \citep[p.\ 229]{lim:12}}}}
...
\item Bill warned us that \myemp{flights to Chicago} we should try to
  avoid. \citep[p.\ 77]{emonds:04}
\item It appears that \myemp{this book} he read
  thoroughly. \citep[p.\ 478]{hooper:thompson:73}
\item I am glad that \myemp{this unrewarding job}, she has finally
  decided to give up. \citep[p.\ 69]{bianchi:frascarelli:10}}}


\noindent These examples imply that left-dislocated constituents can
appear in embedded clauses even in \ili{English}, if the main predicate
...
\textit{Kim-un} \textit{in situ} in \myref{exe:multiple:topics:kor}
...
\nun in Korean (and \wa in Japanese).  \myS{5:sec:lex} provides more
...
(\myS{11:sec:questionnaire}). In the questionnaire, I let users choose
...
\item{\myemp{Speaking of} Coppola, he found him to be ... \citep[p.\ 1916]{roberts:11}}}}
...
\myexe{\enumsentence{\toplabel{def:as-for} The \textit{as for} test:
    ...
    to X, X in S\mysub{1} is a topic. \citep[p.\ 410]{oshima:09}}}
...
{Ken-\textsc{wa} & Iliad-\textsc{acc} & read-\textsc{polite}-\textsc{past}}
{`Ken read Iliad.'  [jpn]}
\item\shortex{3}
{Ken-ni-tsuite-wa, & Iriasu-o & yomi-mashi-ta.}
{Ken-ni-tsuite-\textsc{wa} & Iliad-\textsc{acc} & read-\textsc{polite}-\textsc{past}}
{`As for Ken, he read Iliad.'  [jpn]}
\item\shortex{3}
{Iriasu-wa & Ken-ga & yomi-mashi-ta.}
{Iliad-\textsc{wa} & Ken-\textsc{nom} & read-\textsc{polite}-\textsc{past}}
{`As for Iliad, Ken read it.' [jpn]}
\item\shortex{3}
{Iriasu-ni-tsuite-wa, & Ken-ga & yomi-mashi-ta.}
{Iliad-ni-tsuite-\textsc{wa} & Ken-\textsc{nom} & read-\textsc{polite}-\textsc{past}}
...
A: & {\#All the pop stars wore [$_{f}$ \textsc{dark}] caftan. (Ibid.\ p.\ 144)} \\
\end{tabular}}}
...
and contrastive constituents.\is{contrast}  For example, \citet[p.\ 296]{gundel:99}
...
{Kim-and & Lee-\textsc{nun} & what-\textsc{acc} & read-\textsc{pst}-\textsc{int}}
...
\textit{wh}-questions (Ibid.).\is{contrast}
...
(i.e.\ \isi{semantic focus} in \citet{gundel:99}'s terminology) are
...
\item \shortex{3}
  ...
  {`Zaynab wrote a \textsc{novel}.' [arb] (Ibid.\ p.\ 337)}}}
...
\shortex{3}
  ...
  {`The boys listened to the performance of the jazz pianist.' [rus] \citep[p.\ 519]{neeleman:titov:09}}}}
...
\myexe{\eenumsentence{\toplabel{exe:contrasts} \item[Q:] Who did Bill
    ...
    He gave the {\bf book} to {\sc Mary} and the {\bf magazine} to
    {\sc Sally}. \citep[p.\ 72]{van:05}}}
...
(or topic \is{non-contrastive topic}) in the semantics.
...
\myS{3:sssec:gundel}.  The different behavior between them is also
...
\item The largest demonstrations took place in \textsc{Prague}\mysub{\textsc{cf}} in \textsc{November} (in) 1989. \citep[p.\ 301--302]{gundel:99}}}
...
\multicolumn{10}{l}{interesting.' [jpn] \citep[p.\ 270]{kuno:73}} \\
\end{tabular}}}}
...
\item\shortex{2}
  ...
  {everyone-\textsc{wa} & sleep-\textsc{neg}-\textsc{past}}
  {`Everyone didn't sleep.' \\
    (contrastive \wa) *\ensuremath{\forall}\ensuremath{>}\ensuremath{\neg}, \ensuremath{\surd}\ensuremath{\neg}\ensuremath{>}\ensuremath{\forall} \citep[p.\ 187--188]{nakanishi:07}}}}
...
freely scramble, while completive focus (a.k.a.\ \isi{non-contrastive focus}
...
\item[]\shortex{6}
  ...
  {`I visited a museum already yesterday, I will see a church only tomorrow.' [dan] \citep[p.\ 8--9]{erteschik:07}}}}
...
\citet{gryllia:09} provides six tests to vet the meaning and marking
of \isi{contrastive topic} and \isi{contrastive focus} as follows
(p.\ 42--43).\footnote{For more elaborated explanation and examples
...
\item Substitution test: If two terms are interpreted with a `List
  Interpretation', then they can be substituted with `the former'
  and `the latter'.
...
\item[A:]\shortex{5} {[Maria]\mysub{C-Foc} & ha & rotto & il
  ...
  broken the vase.' [ita] \citep[p.\ 32]{gryllia:09}}}}
...
{no & coffee.\textsc{acc} & want.1\textsc{sg} [ell] (Ibid.\ p.\ 44)}}}

\myexe{\eenumsentence{\toplabel{exe:correction:3}
\item[Q:]\shortex{2}
{chayk & ilk-ess-ni?}
{book &  read-\textsc{pst}-\textsc{int}}
{`Did you read a book?'}
\item[A:]\shortex{3}
...
{\it doo} ... {\it da} in (\ref{exe:nav}a), and the other expresses
corrective \isi{focus}, {\it hanii} in (\ref{exe:nav}b). That is,
...
{`\textsc{John} didn't wreck the car (someone else did).' [nav] (Ibid.\ p.\ 91)}}}
...
\nun-marked in \ili{Korean}, as shown in \myref{exe:clefts:kor}.
...
\myS{10:sssec:clefts:cleft} \mypage{10:sssec:clefts:cleft}.
