...
(\ref{exe:rizzi:306}a) indicates that \ili{English} normally disallow
...
A man who, your book, could buy it. [ita] \citep[p.\ 306]{rizzi:97}}}}
...
types.  These are complement clauses (\myS{10:ssec:embedded}),\is{complement clause}
relative clauses (\myS{10:ssec:relative}),\is{relative clause} and adverbial clauses
(\myS{10:ssec:adjunct}).\is{adverbial clause}  Each section in this chapter
looks into linguistic factors that have an influence
on information structure in each clausal type,\is{HPSG}\is{MRS}
...
\item{Embedded topicalization is impossible in an adjunct clause
  and in a sentential subject. \citep[p.\ 8--10]{maki:etal:99}}}}
...
\item Class E predicates (e.g.\ ``realize'', ``know''); these
  ...
  asserted. \citep[p.\ 189]{heycock:07}}}
...
\nun-marked phrases in \ili{Korean} relative clauses
(\myS{3:sssec:clausal-constraints}).\is{relative clause} If \nun
...
\shortex{4}
  ...
  {`A flower with a good scent blooms.' [kor] \citep[p.\ 229]{lim:12}}}}
...
\mbox{ } \mbox{ } \mbox{ } \mbox{ } 
\mbox{ } \mbox{ } \mbox{ } \mbox{ } 
\mbox{ } \mbox{ } \mbox{ } \mbox{ }\citep[p.\ 757]{bresnan:mchombo:87}
\end{tabular}}}
...
\evnup{\begin{tabular}[h]{lllllllllllll}
   ...
   & \multicolumn{11}{l}{`As a composer it is of course important that the listeners know}\\
   & \multicolumn{11}{l}{that music which it is that is listened to.' [dan] \citep[p.\ 279]{bjerre:11}}
\end{tabular}}}}
...
\isi{topic} function, all relative clauses in Korean and Japanese would be
topicless constructions.\is{topicless}
A second issue is that relative pronouns can
be missing in some circumstances even in \ili{English} (e.g.\ those
...
explain with respect to information structure.\is{relative pronoun}
Lastly, as hypothesized in \myS{9:sec:hypotheses}, relative pronouns
are syncategorematic and their lexical type inherits from
\tdl{no-icons-lex-items} which has an empty list of ICONS. Hence,
...
The thematic constraint on relative clauses: A relative clause
  must be a statement about its head noun. \citep[p.\ 420]{kuno:76}}}
...
{the & book-\textsc{wa} & Hanako-\textsc{nom} & read & book [jpn] \citep[p.\ 419]{kuno:76}}}}
...
{`the people such that an accident happened' [cmn] \citep[p.\ 212--213]{huang:etal:09}}}}
...
{child & that & I.saw & him}
{`It's a child that I saw.' [aka] \citep[p.\ 108]{croft:02}}
\item\shortex{6}
...
\myS{4:sec:lexical}, \textit{n\`{a}} in (\ref{exe:aka:hil}b) behaves
...
of \tdl{info-str}
(Figure~\ref{fig:info-str} \mypage{fig:info-str}). This means that the
...
(\myS{10:sec:fronting}). The preposed constituents in focus/topic
...
\citep[p.\ 177]{heycock:07}.\is{root phenomena} In
...
elaborated in the subsections below.\footnote{Using this strategy,
  ...
  clausal complements (\myS{10:ssec:embedded}).These underspecified
